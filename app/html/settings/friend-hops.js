      ...
      body: h('FriendHops', [
        ...
        h('div.slider', [
          h('datalist', { id: 'friends-hop-datalist' }, [
            h('option', { value: 0, label: 'Only your messages' }),
            h('option', { value: 1, label: 'You and your friend\'s messages' }),
            h('option', { value: 2, label: 'You, your friend\'s, and your friend\'s friend\'s  messages' }),
            h('option', { value: 3, label: 'You, your friend\'s, your friend\'s friend\'s, and their friend\'s messages' })
          ]),
          h('input', {
            type: 'range',
